...
`rippled`の[`fee`コマンド](https://xrpl.org/ja/fee.html)から導出されたメトリクスのスナップショットを返します。_（新規: [v2.3.2][]）_
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-fee-stats)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-topology)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-topology-nodes)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-topology-node)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-topology-links)
...
[コンセンサスネットワーク](https://xrpl.org/ja/consensus.html)内の1つのバリデータに関する詳細を取得します。_（更新: [v2.4.0][]）_
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-validator)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-validators)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-validator-manifests)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-single-validator-reports)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-daily-validator-reports)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-rippled-versions)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-all-gateways)
...
| `account`  | 文字列 - [アドレス][] | この通貨の[発行アドレス](https://xrpl.org/ja/issuing-and-operational-addresses.html)。 |
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-gateway)
...
| `accounts`   | 配列                  | このゲートウェイが使用する[発行アドレス](https://xrpl.org/ja/issuing-and-operational-addresses.html)のリスト。（ゲートウェイは、異なる通貨に異なる発行アカウントを使用することがあります。） |
| `hotwallets` | [アドレス][]の配列 | このゲートウェイの[運用アドレス](https://xrpl.org/ja/issuing-and-operational-addresses.html)。 |
...
| フィールド        | 値  | 説明                                          |
|:-------------|:-------|:-----------------------------------------------------|
| `address`    | 文字列 | このゲートウェイが使用する[発行アドレス](https://xrpl.org/ja/issuing-and-operational-addresses.html)。 |
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-accounts)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-balances)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-orders)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-transaction-history)
...
| `type`         | 文字列                 | 指定された[トランザクションタイプ](https://xrpl.org/ja/transaction-types.html)に結果を制限します。 |
| `result`       | 文字列                 | 指定された[トランザクションの結果](https://xrpl.org/ja/transaction-results.html)に結果を制限します。 |
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-transaction-by-account-and-sequence)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-payments)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-exchanges-all)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-balance-changes)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-reports-by-day)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-transaction-stats)
...
| `result`            | オブジェクト                 | 当該日付でこのアカウントが送信したトランザクションで発生した各結果コードの数を示す[トランザクション結果コード](https://xrpl.org/ja/transaction-results.html)のマップ。 |
| `type`              | オブジェクト                 | アカウントが当該日付に送信した各トランザクションタイプの数を示す[トランザクションタイプ](https://xrpl.org/ja/transaction-formats.html)のマップ。 |
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#get-account-value-stats)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#api-health-check)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#importer-health-check)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#nodes-etl-health-check)
...
[試してみる>](https://xrpl.org/ja/data-api-v2-tool.html#validations-etl-health-check)
...
詳しくは、[アカウント](https://xrpl.org/ja/accounts.html)と[base58エンコード](https://xrpl.org/ja/base58-encodings.html)を参照してください。
...
* コンセンサスプロセスの一環として検証投票に署名するため。これには、サーバーの運用者が[設定ファイルに定義](https://xrpl.org/ja/run-rippled-as-a-validator.html)した「バリデータ公開鍵」が使用されます。
...
レジャーインデックスは、32ビットの符号なし整数であり、レジャーを識別するために使用します。レジャーインデックスは、レジャーの _シーケンス番号_ と呼ばれることもあります。（[アカウントシーケンス](https://xrpl.org/ja/basic-data-types.html#アカウントシーケンス)とは異なります。）一番最初のレジャーでは、レジャーインデックスは1でした。新しいレジャーのレジャーインデックスは、その直前のレジャーのレジャーインデックスに1を加算した値になります。
...
すべての[XRP Ledgerアカウント](https://xrpl.org/ja/accounts.html)には、`Sequence`フィールドに1つのシーケンス番号があり、アカウントがトランザクションを送信し、そのトランザクションが[検証済みレジャー](https://xrpl.org/ja/ledgers.html)に記録されるたびに、1ずつ増加します。シーケンス番号は各[トランザクション](https://xrpl.org/ja/transaction-basics.html)の`Sequence`フィールドにもあり、そのトランザクションが実行される際にアカウントの現在のシーケンス番号と一致している必要があります。各アカウントで、各シーケンス番号は番号順に一度だけ使用できます。

[DeletableAccounts Amendment](https://xrpl.org/ja/known-amendments.html#deletableaccounts) <span class="status not_enabled" title="This feature is not currently enabled on the production XRP Ledger."><i class="fa fa-flask"></i></span> を適用する場合、アカウントの`Sequence`番号の始まりが、アカウントが作成されたレジャーバージョンの[レジャーインデックス][]と一致します。DeletableAccountsを適用しない場合、どのアカウントの`Sequence`番号も1で始まります。

トランザクションがレジャーに記録されると、トランザクションの実行が成功したか[`tec`クラスのエラーコード](https://xrpl.org/ja/tec-codes.html)で失敗したかを問わず、シーケンス番号が1つ消費されます。トランザクションのその他の失敗についてはレジャーに記録されないため、送金元のシーケンス番号は変更されません（その他の影響もありません）。

レジャー内では、[アドレス][]とシーケンス番号を一緒に使用して、その送金元とシーケンス番号を持つ検証済みトランザクションによって作成されたオブジェクトが識別されることがあります。この方法で識別されたオブジェクトの例として、[Escrow](https://xrpl.org/ja/escrow.html)と[オファー](https://xrpl.org/ja/offers.html)が挙げられます。
...
* 160ビットの16進値。例えば`0158415500000000C1F76FF6ECB0BAC600000000`など、XRP Ledgerの内部[通貨フォーマット](https://xrpl.org/ja/currency-formats.html)に準じたものです。この表記は一般的ではありません。
...
| `tx`           | オブジェクト                    | このトランザクションオブジェクトのフィールド。[トランザクションのフォーマット](https://xrpl.org/ja/transaction-formats.html)により定義されます。 |
...
Data APIでは、ペイメントオブジェクトはアカウント間で価値が移動したイベントを表します。これはほとんどの場合、`Payment` [トランザクションタイプ](https://xrpl.org/ja/transaction-types.html)のXRP Ledgerトランザクションに対応します。ただし Data APIでは、送金元`Account` と`Destination`アカウントが同一である場合、またはトランザクションが失敗した場合には、トランザクションはペイメントとして見なされません。
...
| `destination_tag`             | 整数                    | （省略される場合があります）このペイメントに指定された[送金先タグ](https://xrpl.org/ja/become-an-xrp-ledger-gateway.html#source-and-destination-tags)。 |
| `source_tag`                  | 整数                    | （省略される場合があります）このペイメントに指定された[送金元タグ](https://xrpl.org/ja/become-an-xrp-ledger-gateway.html#source-and-destination-tags)。 |
...
「サーバーオブジェクト」は、XRP Ledgerピアツーピアネットワークの1つの`rippled`サーバーを表します。サーバーオブジェクトは[Get Topology](#get-topology)、[Get Toplogy Nodes](#get-topology-nodes)、および[Get Topology Node](#get-topology-node)メソッドで返されます。Data APIは、[ピアクローラー](https://xrpl.org/ja/peer-crawler.html)を使用して、報告されるネットワークトポロジーを約30秒間隔で収集します。
...
| `port`             | 整数                         | （省略される場合があります）このサーバーが[`rippled`ピアプロトコル](https://xrpl.org/ja/peer-protocol.html)を使用するポート。 |
...
<!-- common links -->
[アドレス]: https://xrpl.org/ja/basic-data-types.html#アドレス
[base58]: https://xrpl.org/ja/base58-encodings.html
[通貨額]: https://xrpl.org/ja/basic-data-types.html#通貨額の指定
[通貨額の指定]: https://xrpl.org/ja/basic-data-types.html#通貨額の指定
[通貨コード]: https://xrpl.org/ja/currency-formats.html#通貨コード
[ハッシュ]: https://xrpl.org/ja/basic-data-types.html#ハッシュ
[レジャーインデックス]: https://xrpl.org/ja/basic-data-types.html#レジャーインデックス
[シーケンス番号]: https://xrpl.org/ja/basic-data-types.html#アカウントシーケンス
[トランザクションコスト]: https://xrpl.org/ja/transaction-cost.html
