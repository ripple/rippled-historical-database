...
/*    
    SELECT ledger_index, transactions.raw, transactions.meta 
    FROM accounts
    JOIN account_transactions on accounts.account_id = account_transactions.account_id
    JOIN transactions on account_transactions.tx_id = transactions.tx_id
