  ...
  function aggregate () {
    ...
    .then(function() {
      return Promise.all([
        ...
        self._aggregateInterval(30, 'minute', 'minute'),
...
ExchangeAggregation.prototype._aggregateMinutes = function(incoming) {
  ...
  //console.log(self.updated.agg_exchange_1minute);

  //save to hbase
  return self.hbase.putRows('agg_exchanges', self.updated.agg_exchange_1minute);
};
...
ExchangeAggregation.prototype._aggregateInterval = function (multiple, period, interval) {
  ...
  //save to hbase
  return self.hbase.putRows('agg_exchanges', self.updated[table]);
};
